    ...
    <div className=" min-h-screen flex flex-col lg:flex-row items-center md:mx-32 mx-5 gap-14">
      <div className=" w-full lg:w-2/4">
        <div className=" space-y-4">
          ...
          <p>
            At Sitron Investments, our core value is to consistently uphold
            integrity, prioritize customer satisfaction, deliver exceptional
            quality, foster innovation and demonstrate social and environmental
            responsibility.
          </p>
        </div>
